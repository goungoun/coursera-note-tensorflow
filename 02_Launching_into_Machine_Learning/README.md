...
- Use validation data set to prevent overfitting: As soon as you start seeing your models not perform well against your validation data set, like if your loss metrics start to increase or creep up, it's time to stop.
